...
def generate_summary_report():
    ...
    # Load both datasets
    original_df = pd.read_csv('data/processed/peptide_baza_formatted.csv', sep=';')
    balanced_df = pd.read_csv('data/processed/peptide_baza_balanced.csv', sep=';')
    ...
    print("\n8. FILES CREATED")
    print("-" * 50)
    print("✓ data/processed/peptide_baza_balanced.csv - Main balanced dataset")
    print("✓ src/smote_balance.py - SMOTE implementation script")
    print("✓ src/diagnostics/verify_balance.py - Dataset verification script")
