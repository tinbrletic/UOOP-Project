...
def create_balanced_peptide_dataset():
    ...
    try:
        ...
        df = pd.read_csv('data/processed/peptide_baza_formatted.csv', sep=';')
        ...
        output_file = 'data/processed/peptide_baza_balanced.csv'
...
if __name__ == "__main__":
    ...
    if success:
        ...
        print("="*60)
        print("\nFiles created:")
        print("- data/processed/peptide_baza_balanced.csv: Balanced dataset with synthetic samples")
